...
export SPARK_SUBMIT_OPTIONS="--jars /opt/bluedata/bluedata-dtap.jar,/opt/bluedata/aws-java-sdk-1.7.4.jar,/opt/bluedata/hadoop-aws-2.7.1.jar,/usr/lib/sparklingwater/sparkling-water-2.1.5/assembly/build/libs/sparkling-water-assembly_2.11-2.1.5-all.jar"
